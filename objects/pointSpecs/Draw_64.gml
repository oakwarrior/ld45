...
draw_text_transformed(300-2,155-2,"POINTS: "+string(round(global.points))+"/"+string(instance_number(oPoint)),0.3,0.3,0)
...
draw_set_font(font0)
draw_set_color($321238)
draw_text_transformed(300-2,155-2,"POINTS: "+string(round(global.points))+"/"+string(pointso),0.3,0.3,0)
draw_set_color(c_white)
